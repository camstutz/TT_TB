...
modules   += $(MODULEDIR)/backend/trigger_tower $(MODULEDIR)/backend/data_organizer $(MODULEDIR)/backend/processor_organizer
modules   += $(MODULEDIR)/backend/trigger_tower/pattern_bank $(MODULEDIR)/backend/trigger_tower/module_address_lookup
...
modules   += $(MODULEDIR)/backend/am_board/track_finder/hit_processor
