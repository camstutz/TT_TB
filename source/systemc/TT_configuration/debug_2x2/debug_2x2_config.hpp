...
inline track_trigger_config debug_2x2_config()
{
...
//    configuration.trigger_tower.set_dtc_per_prb(2);
    configuration.trigger_tower.set_prb_nr(2);
...
//
    configuration.read_track_trigger_config("source/systemc/TT_configuration/debug_2x2/debug_2x2", "source/systemc/TT_configuration/debug_2x2/debug_2x2_sectors.csv");
