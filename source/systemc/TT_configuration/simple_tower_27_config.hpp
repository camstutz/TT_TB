/*!
 * @file simple_tower_27_config.hpp
...
inline track_trigger_config simple_tower_27_config()
{
...
//
    configuration.read_track_trigger_config("source/systemc/TT_configuration/simple_tower_27", "data/configuration/baseline_Eta6_Phi8.csv");
