...
/*!
 * @class bx_stub_buffer_tb
 * The module is sensitive to ...
 */

bx_stub_buffer_tb::bx_stub_buffer_tb(sc_module_name _name) :
        sc_module(_name),
        stub_input_fifo("stub_input_fifo"),
        bunch_crossing_select_sig("bunch_crossing_select_sig"),
        output_fifo("output_fifo"),
        dut_do_stub_buffer("bx_stub_buffer")
{
...
// *****************************************************************************
bx_stub_buffer_tb::~bx_stub_buffer_tb()
{
...
// *****************************************************************************
void bx_stub_buffer_tb::write_stubs()
{
    ...
    stub_input_fifo.write(do_stub_buffer::input_pair_t(6, stub_element));
    ...
    stub_element.set_stub(stub);
    stub_input_fifo.write(do_stub_buffer::input_pair_t(8, stub_element));
...
// *****************************************************************************
void bx_stub_buffer_tb::print_output()
{
    while(1)
    {
         wait();
