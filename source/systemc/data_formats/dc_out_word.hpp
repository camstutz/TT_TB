...
public:
    ...
    typedef stub_bxfsb<DC_WORD_TIME_BITS, DC_WORD_FE_BITS, FE_CBC_STUB_STRIP_BITS, FE_CBC_STUB_BEND_BITS,
            DC_WORD_TIME_BITS+DC_WORD_FE_BITS+FE_CBC_STUB_STRIP_BITS+FE_CBC_STUB_BEND_BITS> dc_stub_t;
